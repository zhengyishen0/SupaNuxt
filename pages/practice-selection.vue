...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-4">
      <h1 class="text-2xl font-semibold text-center mb-4">Choose a Full-Length Practice</h1>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-2">
              <Label class="block text-sm font-medium">
                Test Type*
                <span class="text-xs text-gray-500 float-right">* = Required</span>
              </Label>
              <Select v-model="testType">
                ...
                <SelectContent>
                  <SelectItem v-for="type in testTypes" :key="type" :value="type">
                    {{ type }}
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div class="space-y-2">
              ...
              <Select v-model="practiceTest">
                ...
                <SelectContent>
                  <SelectItem v-for="test in practiceTests" :key="test" :value="test">
                    {{ test }}
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div class="space-y-2">
              ...
              <p class="text-xs text-gray-500">
                Note: Selecting a testing accommodation here does not mean you will
                receive it on test day.
